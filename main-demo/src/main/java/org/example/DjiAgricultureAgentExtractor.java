...
public class DjiAgricultureAgentExtractor {
    static final String TPL_AGENT_URL = "https://www-api.dji.com/api/where-to-buy/agriculture-dealer-maps?area=%s";
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        for (String continent : CONTINENTS) {
            ...
            for (Object obj : storesArr) {
                ...
                JSONArray agentArr = areaObj.getJSONArray("mg_distributors");
        ...
        Util.write(workbook, "result/dji-agriculture-agents.xlsx");
    }
